...
function App() {
  const baseUrl = 'https://www.gustabin.com/varios/tutoriales/apiphp/';
  ...
  return (
    <Layout>
      <Head>
        <title>ModalAPI page</title>
        <meta name="description" content="content of ModalAPI page" />
      </Head>
      <div className="App">
        <h2>API rest php en gustabin.com</h2>
        <div>
          <br />
          <button
